        ...
        {value.map((url) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 right-2 bg-red-600 hover:bg-red-700 text-white rounded-xl h-10 w-10 flex items-center justify-center transition-all shadow-md z-10 cursor-pointer focus:outline-none focus:ring-2 focus:ring-red-500"
